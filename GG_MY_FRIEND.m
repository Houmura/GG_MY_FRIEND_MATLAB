a = 1.5/100;     %INPUT PROBABILITIES HERE 
b = 1.5/100;
c = 3.5/100;
d = 3.5/100;
e = 3.5/100;
...
hold on;
plot(N,P2,'LineWidth',2,'Color','y');
hold on;
plot(N,P3,'LineWidth',2,'Color','g');
hold on;
plot(N,P4,'LineWidth',2,'Color','b');
hold on;
plot(N,P5,'LineWidth',2,'Color','k');
grid on
xlabel('活动建造次数');
ylabel('活动未毕业概率 (单位：%)');
